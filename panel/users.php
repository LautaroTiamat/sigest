...
sessionPanelVerify();
userRank();
$pageTitle = $pageUserList;

$consulta = $conexion->query("SELECT * FROM users U JOIN persons P ON U.person_ID = P.person_ID");
                ...
                <div class="row">
                    ...
                    <div class="col-5 align-self-center">
                        <div class="customize-input float-right">
                            <a href="add-user.php" class="btn btn-info"><?php echo $pageAddUser; ?></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <table id="multi_col_order" class="table table-striped table-bordered display no-wrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $person->person_name.' '.$person->person_lastname ?></td>
                                                <td><?php echo $person->user_email ?></td>
                                                <td><a href="edit-user.php?id=<?php echo $person->user_ID ?>">Editar</a></td>
                                                <td><a href="delete-user.php?id=<?php echo $person->user_ID ?>">Eliminar</a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
